...
- Deploy to Railway from your own Railway account, mount persistent SQLite storage at `/data`, and add the deployed URL to the report.
...
2. Deploy with the settings in `docs/deployment/RAILWAY.md`.
3. Add the deployed URL to the report if deployment is required.
